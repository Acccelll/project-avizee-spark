...
const statusConfig: Record<string, { classes: string; icon: typeof Clock; label: string }> = {
  ...
  aprovado:        { classes: 'bg-success/10 text-success border-success/20', icon: CheckCircle, label: 'Aprovado' },
  aprovada:        { classes: 'bg-success/10 text-success border-success/20', icon: CheckCircle, label: 'Aprovada' },
  ...
  confirmado:      { classes: 'bg-success/10 text-success border-success/20', icon: CheckCircle, label: 'Aguardando Aprovação' },
  confirmada:      { classes: 'bg-success/10 text-success border-success/20', icon: CheckCircle, label: 'Aguardando Aprovação' },
