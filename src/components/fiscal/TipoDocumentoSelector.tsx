...
const OPTIONS: Option[] = [
  ...
  { value: "cte", label: "CT-e", description: "Modelos 57 e 67 (CT-e OS)", icon: Truck },
];
...
export function TipoDocumentoSelector({ value, onChange, disabled }: Props) {
  const uiValue: TipoDocumentoFiscal = value === "cte_os" ? "cte" : value;
  return <div>
