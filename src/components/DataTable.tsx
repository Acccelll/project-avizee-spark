          ...
          <>
            ...
            <div className="mt-3 flex items-center justify-between px-1 py-2 pb-24 md:pb-2">
              ...
              {serverPagination ? (
                ...
                <div className="flex gap-1">
                    {currentPage > 0 && (
                      <Button variant="ghost" size="icon" className="h-9 w-9" aria-label="Página anterior" onClick={() => setCurrentPage((p) => p - 1)}><ChevronLeft className="h-4 w-4" /></Button>
                    )}
                    {currentPage < totalPages - 1 && (
                      <Button variant="ghost" size="icon" className="h-9 w-9" aria-label="Próxima página" onClick={() => setCurrentPage((p) => p + 1)}><ChevronRight className="h-4 w-4" /></Button>
                    )}
                  </div>
              )}
            </div>
