...
export function ImportacaoResumoCards({
  ...
  const cards = [
    ...
    },
    {
      ...
      color: (totalPendenciasConferencia ?? totalPending) > 0 || totalConcluidosComAlertas > 0 ? "text-warning" : "text-muted-foreground",
      bg: (totalPendenciasConferencia ?? totalPending) > 0 || totalConcluidosComAlertas > 0 ? "bg-warning/10" : "bg-muted",
    },
  ];
