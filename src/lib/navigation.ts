    ...
    items: [
      {
        ...
        items: [
          ...
          { title: 'Apresentação Gerencial', path: '/relatorios/apresentacao-gerencial', keywords: ['pptx', 'powerpoint', 'apresentacao', 'slides', 'gerencial'] },
        ],
      },
    ],
  },
...
const baseRouteLabels: Record<string, string> = {
  ...
  '/relatorios/workbook-gerencial': 'Workbook Gerencial',
  '/relatorios/apresentacao-gerencial': 'Apresentação Gerencial',
  '/social': 'Social',
  '/fiscal': 'Fiscal',
