...
export const DEFAULT_LAYOUT: DashboardLayoutItem[] = [
  ...
  { i: 'financeiro', x: 0, y: 5, w: 8, h: 7, minW: 4, minH: 3 },
  { i: 'acoes_rapidas', x: 8, y: 5, w: 4, h: 7, minW: 3, minH: 2 },
  { i: 'vendas_chart', x: 0, y: 12, w: 6, h: 5, minW: 4, minH: 3 },
  { i: 'pendencias', x: 6, y: 12, w: 6, h: 5, minW: 4, minH: 2 },
  { i: 'comercial', x: 0, y: 17, w: 6, h: 5, minW: 4, minH: 3 },
  { i: 'estoque', x: 6, y: 17, w: 6, h: 5, minW: 4, minH: 3 },
  { i: 'logistica', x: 0, y: 22, w: 6, h: 5, minW: 4, minH: 2 },
  { i: 'fiscal', x: 6, y: 22, w: 6, h: 5, minW: 4, minH: 2 },
];
