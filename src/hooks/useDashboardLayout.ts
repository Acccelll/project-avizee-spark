...
export const DEFAULT_LAYOUT: DashboardLayoutItem[] = [
  ...
  { i: 'financeiro', x: 0, y: 5, w: 8, h: 5, minW: 4, minH: 3 },
  { i: 'acoes_rapidas', x: 8, y: 5, w: 4, h: 5, minW: 3, minH: 3 },
  { i: 'vendas_chart', x: 0, y: 10, w: 6, h: 5, minW: 4, minH: 3 },
  { i: 'pendencias', x: 6, y: 10, w: 6, h: 5, minW: 4, minH: 3 },
  { i: 'comercial', x: 0, y: 15, w: 6, h: 6, minW: 4, minH: 3 },
  { i: 'estoque', x: 6, y: 15, w: 6, h: 6, minW: 4, minH: 3 },
  { i: 'logistica', x: 0, y: 21, w: 6, h: 5, minW: 4, minH: 3 },
  { i: 'fiscal', x: 6, y: 21, w: 6, h: 5, minW: 4, minH: 3 },
];
