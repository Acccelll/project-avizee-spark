...
export interface FiscalKpisResult {
  ...
  pendente: number;
  confirmada: number;
  /** Inclui `confirmada + autorizada + importada`. */
...
const EMPTY_KPIS: FiscalKpisResult = {
  totalCount: 0,
  rascunho: 0,
  pendente: 0,
  confirmada: 0,
 ...
 * mesmos filtros server-side da listagem paginada.
 */
export async function fetchKpisFiscal(
