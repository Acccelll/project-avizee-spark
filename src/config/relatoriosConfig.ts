...
const topSaidasProdutosConfig: ReportConfig = {
  ...
  description: 'Produtos com maior saída por mês do ano (jan–dez) considerando todo o histórico',
  objective: 'Detectar sazonalidade: quais produtos mais saem em cada mês do ano, somando todos os anos anteriores',
  category: 'estoque_suprimentos',
  icon: TrendingUp,
  chartType: 'bar',
  columns: [
    { key: 'mes', label: 'Mês do Ano' },
    { key: 'codigo', label: 'Código' },
    { key: 'produto', label: 'Produto' },
    { key: 'quantidade', label: 'Qtd. Total (histórico)', format: 'quantity', align: 'right', footerTotal: true },
    { key: 'anosCobertos', label: 'Anos', format: 'number', align: 'right' },
    { key: 'mediaAnual', label: 'Média por Ano', format: 'quantity', align: 'right' },
  ...
  kpis: [
    { key: 'totalSaidas', label: 'Total de Saídas', format: 'number', variation: 'unidades no histórico' },
    { key: 'produtosDistintos', label: 'Produtos', format: 'number', variation: 'distintos com saída' },
    { key: 'anosCobertos', label: 'Anos', format: 'number', variation: 'com movimentação' },
  ],
  drillDown: [
    { key: 'produto', label: 'Abrir produto', route: '/produtos', targetField: 'produtoId', available: true },
    { key: 'movimentos', label: 'Ver movimentações', route: '/relatorios?tipo=movimentos_estoque', targetField: 'produtoId', available: true },
