...
- [Framework Fiscal — plataforma de plugins](mem://fiscal-framework/platform) — Etapa 13: src/modules/fiscal/platform (núcleo agnóstico, registries de documento/layout/serviço/validador/builder/evento/integração/workflow, SDK, template, adapter NF-e)
- [Framework Fiscal — Release 1.0](mem://fiscal-framework/release-1-0) — Etapa 14: baseline oficial, docs/fiscal-framework/etapa-14 (auditoria, ADR index, inventários, manuais, release notes, roadmap, relatório executivo), RELEASE_1_0_BASELINE em src/modules/fiscal/release
